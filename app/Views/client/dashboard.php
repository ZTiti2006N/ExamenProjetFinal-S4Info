        ...
        <div class="main-content">
            ...
            <div class="content-area">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="balance-card">
                            ...
                            <div class="balance-amount" id="displayBalance"><?= number_format($balance, 0, ',', ' ') ?> <small style="font-size:1rem;font-weight:400;">Ar</small></div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="action-card">
                            <div class="action-icon" style="background:#dbeafe;color:#2563eb;"><i class="fas fa-arrows-left-right"></i></div>
                            <h6>Transfert</h6>
                            <p>Envoyer de l'argent à un autre client</p>
                        ...
                        <div class="action-card">
                            ...
                            <?php if (!empty($history)): ?>
                                ...
                                <div class="activity-item">
                                    ...
                                    <span class="badge <?= $op['status'] === 'completed' ? 'bg-success' : 'bg-warning' ?> rounded-pill" style="font-size:0.7rem;">
                                        <?= $op['status'] ?>
                                    </span>
                                </div>
                                <?php endforeach; ?>
            ...
            <div class="modal-content">
                <form action="/client/deposit" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success rounded-pill"><i class="fas fa-check me-1"></i>Confirmer le dépôt</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <form action="/client/withdrawal" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div class="form-text">Des frais peuvent s'appliquer selon le barème configuré.</div>
                        </div>
                        <div class="alert alert-warning mb-0">
                            <i class="fas fa-info-circle me-1"></i> Solde actuel : <strong id="modalBalance"><?= number_format($balance, 0, ',', ' ') ?> Ar</strong>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary rounded-pill" data-bs-dismiss="modal">Annuler</button>
                        <button type="submit" class="btn btn-danger rounded-pill"><i class="fas fa-check me-1"></i>Confirmer le retrait</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/client/transfer" method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="fas fa-exchange-alt text-primary me-2"></i>Effectuer un transfert</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" name="recipient_phone" maxlength="10" required placeholder="0331234567">
                            </div>
                            <div class="form-text">Numéro à 10 chiffres du destinataire</div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Montant du transfert (Ar)</label>
                            <div class="input-group">
                                <span class="input-group-text">Ar</span>
                                <input type="number" class="form-control" name="amount" min="100" step="100" required placeholder="Ex: 5000">
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary rounded-pill" data-bs-dismiss="modal">Annuler</button>
                        <button type="submit" class="btn btn-primary rounded-pill"><i class="fas fa-paper-plane me-1"></i>Confirmer le transfert</button>
                    </div>
                </form>
            </div>
        </div>
